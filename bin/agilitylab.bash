...
# Python connection reads CRCL socket port 64444 for status.
#cmd+=( --tab  --working-directory="$q" -e 'bash -c "printf \"\e]2;PYTHON CRCL STATUS\a\"; cd $p/Python; python cannedcrclclient.py;exec bash"')
