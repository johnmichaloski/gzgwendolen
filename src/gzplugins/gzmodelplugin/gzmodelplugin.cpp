...
void gzModelPlugin::onWorldUpdate()
{
    ...
    for (size_t m = 0; m< models.size(); m++)
    {
        try {
...
#else
            msg.set_allocated_pose(new gazebo::msgs::Pose(gazebo::msgs::Convert (pose.Ign())) );
#endif
            ...
            ignition::math::Vector3d vbox( bbox.GetMax()-bbox.GetMin());
