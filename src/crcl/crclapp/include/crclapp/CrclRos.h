...
/**
 * @brief The CRosCrclClient class handles
...
public:
     ...
     */
    CRosCrclClient(boost::shared_ptr<crcl::crclServer> crcl2ros);
    boost::shared_ptr<crcl::crclServer> crcl2ros;  // decode ROS status into CRCL status
