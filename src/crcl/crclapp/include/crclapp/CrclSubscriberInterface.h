...
namespace Crcl {
    ...
    class CrclSubscriberDelegateInterface {
    public:
        ...
        static CrclStatus crclsettings; // this is crcl wm different that controller wm
        ...
        /**
              ...
              */
        virtual CrclReturn SetEndEffectorParameters(std::vector<std::string> name, std::vector<std::string> value);
